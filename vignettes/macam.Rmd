...
y1_smap_rEDM <- block_lnlp(block_y1, method = "s-map", theta = 0.1)
## Normal S-map by macam
y1_smap_macam <- s_map_regl(block_y1, theta = 0.1, regularized = F)
## Regularized S-map (ridge)
y1_ridge <- s_map_regl(block_y1, theta = 0.1, lambda = 0.1,
                       regularized = T, alpha = 0, random_seed = 1234)
## Regularized S-map (lasso)
y1_lasso <- s_map_regl(block_y1, theta = 0.1, lambda = 0.1,
                       regularized = T, alpha = 1, random_seed = 1234)

# Check RMSE
y1_smap_rEDM$rmse; y1_smap$stats$rmse
