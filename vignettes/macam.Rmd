...
# Load data
data(data_4sp)
effect_var <- "Tridentiger.trigonocephalus"
...
uic_res <- uic_across(data_4sp, effect_var, E_range = 0:10, tp_range = -4:0)
...
mdr_res$stats # rho = 0.40; rmse = 43.57

# Compare with the normal S-map
smap_res <- rEDM::block_lnlp(data_4sp, target_column = effect_var,
                 method = "s-map", theta = 8, tp = 1)
smap_res$rho # rho = 0.34
smap_res$rmse # rho = 49.29
