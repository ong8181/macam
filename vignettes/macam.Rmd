...
y1_smap_macam <- s_map_regl(y1, E = Ey1, theta = 0.1, regularized = F)
## Regularized S-map (ridge)
y1_ridge <- s_map_regl(y1, E = Ey1, theta = 0.1, lambda = 0.1,
                       regularized = T, alpha = 0, random_seed = 1234)
## Regularized S-map (lasso)
y1_lasso <- s_map_regl(y1, E = Ey1, theta = 0.1, lambda = 0.1,
